          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-12 d-flex align-items-center" style="justify-content:space-between">                          
                <a href="{{ route('users.machine') }}" class="btn btn-secondary d-flex align-items-center"><i class='bx bxs-left-arrow' style="padding-right:.25rem"></i>ย้อนกลับ</a>
              </div>             
            </div>
          </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg bg-warning d-flex align-items-center"style="justify-content: space-between">
                            <div class="box"><i class="bi bi-pencil-square" style="padding-right:.5rem"></i>แก้ไขข้อมูลเครื่องจักรหน่วยงาน</div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('users.updateMachine',$machine->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf                                
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="brand" class="d-flex"><i class="bi bi-asterisk" style="color:red;font-size:7px"></i>ยี่ห้อรถ</label>
                                        <input type="text" class="form-control input_data" id="Brandcar" name="brand" list="Brand_machine"placeholder="กรุณาเลือกยี่ห้อ" value="{{$machine->brand}}" onkeyup="this.value = this.value.toUpperCase();" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control input_data" id="Modelcar" name="model" placeholder="กรุณาใส่รุ่นรถ  (ตัวอย่าง TRITON)" onkeyup="this.value = this.value.toUpperCase();" value="{{$machine->model}}" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="" class="form-label label_top d-flex">
                                            <i class="bi bi-asterisk" style="color:red;font-size:7px"></i>ประเภทรถ                                        
                                        </label>
                                        <input type="text" class="form-control input_data" name="type" value="{{$machine->type}}" list="Type_machine" placeholder="กรุณาเลือกประเภท" required>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control input_data" name="license" id="Licensecar" placeholder="กรุณาใส่ทะเบียนรถ  (ตัวอย่าง บว-4007)" value="{{$machine->license}}" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="" class="form-label label_top d-flex">
                                            <i class="bi bi-asterisk" style="color:red;font-size:7px"></i>รหัส                                        
                                        </label>
                                        <input type="text" class="form-control input_data" name="code_machine" id="Code_machinecar" placeholder="กรุณาใส่รหัส  (ตัวอย่าง 001-54-0091)" value="{{$machine->code_machine}}" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control input_data" id="" name="year" placeholder="กรุณาใส่ปีที่จัดซื้อ  (ตัวอย่าง 2564)" value="{{$machine->year}}" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="" class="form-label label_top d-flex">
                                            <i class="bi bi-asterisk" style="color:red;font-size:7px"></i>งบประมาณ                                        
                                        </label>
                                        <input type="text" class="form-control input_data" id="" name="budget" placeholder="กรุณาใส่งบประมาณ  (ตัวอย่าง 493800)" value="{{$machine->budget}}" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="" class="form-label label_top d-flex">
                                            <i class="bi bi-asterisk" style="color:red;font-size:7px"></i>หน่วยงานที่ใช้งาน                                        
                                        </label>
                                        <input type="text" class="form-control input_data" id="" name="owner" placeholder="กรุณาเลือกหน่วยงาน" list="Owner_car" value="{{$machine->owner}}" required>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <label for="" class="form-label label_top d-flex">
                                            ...
                                            <input type="text" class="form-control input_data" id="Name_res_car" name="responsible_person" placeholder="กรุณาใส่ ชื่อ นามสกุล  (ตัวอย่าง มานี  ปรีดาชัย)" value="{{$machine->responsible_person}}" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="" class="form-label label_top d-flex">
                                            <i class="bi bi-asterisk" style="color:red;font-size:7px"></i>เบอร์โทรศัพท์                                            
                                        </label>
                                            <input type="text" class="form-control input_data" id="Phonecar" name="phone" placeholder="กรุณาใส่เบอร์โทรศัพท์" maxlength="10" value="{{$machine->phone}}" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-12">
                                        <label for=" " class="form-label label_top"> หมายเหตุ </label>
                                        <input type="text" class="form-control input_data" id="Notecar" name="note" placeholder="กรุณาใส่หมายเหตุ (ถ้ามี)" value="{{$machine->note}}">
                                    </div>
                                </div>
