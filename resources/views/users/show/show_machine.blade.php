            ...
            <div class="row mb-2">
              <div class="col-sm-12 d-flex align-items-center" style="justify-content:space-between">   
                <div class="d-flex">                       
                    ...
                    <a href="{{ route('users.editMachine',$machine->id) }}" class="btn btn-warning" style="margin-left:2rem"><i class="bi bi-pencil-square"style="padding-right:.25rem"></i>แก้ไขข้อมูล</a>
                </div>
              </div>             
            </div>
          </div>
