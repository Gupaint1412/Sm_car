      ...
      <div class="row mb-2">
        <div class="col-sm-12 d-flex align-items-center" style="justify-content:space-between">
            <div class="d-flex">
                ...
                <a href="{{ route('users.addMachine' )}}" class="btn btn-success"><i class="bi bi-plus-lg" style="margin-right:.3rem;"></i>เพิ่มข้อมูลใหม่</a>
            </div>                                   
              ...
              <tbody>
                ...
                <tr style="text-align:center">
                  ...
                  <td style="padding: 12px">
                    <a href="{{route('users.showMachine',$k->id)}}" class="btn btn-info"style="margin-right:.25rem;font-size:12px"><i class="bi bi-search"></i></a>
                    <a href="{{route('users.editMachine',$k->id)}}" class="btn btn-warning"style="margin-right:.25rem;font-size:12px"><i class="bi bi-pencil-square"></i></a>                    
                  </td>
                </tr>                                
                @endforeach
              </tbody>
