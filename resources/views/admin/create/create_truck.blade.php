          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-12 d-flex align-items-center" style="justify-content:space-between">                          
                <a href="{{ route('admin.truck') }}" class="btn btn-secondary d-flex align-items-center"><i class='bx bxs-left-arrow' style="padding-right:.25rem"></i>ย้อนกลับ</a>
              </div>             
            </div>
          </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg bg-primary d-flex align-items-center" style="justify-content: space-between">
                            <div class="box"><i class="bi bi-plus-square" style="padding-right:.5rem"></i>เพิ่มข้อมูลรถบรรทุก</div>
                            <i class='bi bi-truck' style="margin-left: auto;font-size:20px"></i>
                        </div>
                        <div class="card-body">
                            <form action="{{route('admin.storeTruck')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="brand" class="form-label label_top d-flex"><i class="bi bi-asterisk" style="color:red;font-size:7px"></i>ยี่ห้อรถ</label>                                        
                                        <input type="text" class="form-control input_data" id="Brandcar" name="brand" list="Brand_truck"placeholder="กรุณาเลือกยี่ห้อ" onkeyup="this.value = this.value.toUpperCase();" required>
                                        <datalist id="Brand_truck">    
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control input_data" name="type" id="" list="Type_truck" placeholder="กรุณาเลือกประเภท" required>
