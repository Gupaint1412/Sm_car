                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg bg-primary d-flex align-items-center" style="justify-content: space-between">
                            <div class="box"><i class="bi bi-plus-square" style="padding-right:.5rem"></i>เพิ่มข้อมูลเครื่องใช้ทั่วไป</div>
                            <i class='bi bi-tools' style="margin-left: auto;font-size:20px"></i>
                        </div>
                        <div class="card-body">
                            <form action="{{route('admin.storeGeneral')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="brand" class="form-label label_top d-flex"><i class="bi bi-asterisk" style="color:red;font-size:7px"></i>ยี่ห้อ</label>                                        
                                        <input type="text" class="form-control input_data" id="Brandcar" name="brand" list="Brand_general"placeholder="กรุณาเลือกยี่ห้อ" onkeyup="this.value = this.value.toUpperCase();" required>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control input_data" id="Modelcar" name="model" placeholder="กรุณาใส่รุ่น  (ตัวอย่าง PC200-5A)" onkeyup="this.value = this.value.toUpperCase();" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="" class="form-label label_top d-flex">
                                            <i class="bi bi-asterisk" style="color:red;font-size:7px"></i>ประเภท                                     
                                        </label>
                                        <input type="text" class="form-control input_data" name="type" id="" list="Type_general" placeholder="กรุณาเลือกประเภท" required>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control input_data" name="license" id="Licensecar" placeholder="กรุณาใส่ทะเบียน  (ตัวอย่าง ต-6411)" required>
                                    </div>
                                    <div class="col-md-4">
                                        <label for="" class="form-label label_top d-flex">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control input_data" name="hp_kw" id="Hp_kw" placeholder="กรุณาใส่จำนวนแรงม้า  (ตัวอย่าง 170)" required>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-md-4">
