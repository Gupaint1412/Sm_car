      ...
      <div class="row mb-2">
        <div class="col-sm-12 d-flex align-items-center" style="justify-content:space-between">
          <div class="d-flex">
            ...
            <a href="{{ route('admin.addTruck' )}}" class="btn btn-success"><i class="bi bi-plus-lg" style="margin-right:.3rem;"></i>เพิ่มข้อมูลใหม่</a>
          </div>                                   
              ...
              <tbody>
                ...
                <tr style="text-align:center">
                  ...
                  <td style="padding: 12px">
                    <a href="{{route('admin.showTruck',$k->id)}}" class="btn btn-dark"style="margin-right:.25rem;font-size:12px"><i class="bi bi-search"></i></a>
                    <a href="{{route('admin.editTruck',$k->id)}}" class="btn btn-dark"style="margin-right:.25rem;font-size:12px"><i class="bi bi-pencil-square"></i></a>
                    <a href="#" data-toggle="modal" data-target="#exampleModalCenter_{{$k->id}}" data-action="{{ route('admin.deleteTruck', $k->id) }}" class="btn btn-danger"style="margin-right:.25rem;font-size:12px"><i class="bi bi-trash3"></i></a>
                  </td>
                </tr>
                  <!-- Modal -->
                  <div class="modal fade" id="exampleModalCenter_{{$k->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                      <div class="modal-content">
                        ...
                        <form action="{{ route('admin.deleteTruck', $k->id) }}" method="post">
                          @csrf
