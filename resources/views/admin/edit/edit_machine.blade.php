        ...
        <section class="content">
          <div class="container-fluid">
              <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg bg-warning d-flex align-items-center"><i class="bi bi-pencil-square" style="padding-right:.5rem"></i>แก้ไขข้อมูลเครื่องจักรหน่วยงาน</div>
                        <div class="card-body">
